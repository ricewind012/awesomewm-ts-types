...
interface AwfulPrompt {
	 ...
	 * @param textbox this and below args are deprecated so not doing this lol
	 * @param exe_callback
	 * @param completion_callback
	 * @param history_path
	 * @param history_max
	 * @param done_callback
	 * @param changed_callback
	 * @param keypressed_callback
	 */
	run(
		args: {
			/**
			 ...
			 */
			keypressed_callback?: (mod: table, key: string, command: string) => void;
			 ...
			 * @param command The current command.
			 */
			keyreleased_callback?: (mod: table, key: string, command: string) => void;
