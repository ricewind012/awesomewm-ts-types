...
export function TagList(props: TagListProps) {
	...
	const buttons = [
		...
		// in it.
		awful.button<AwesomeTag>([modkey], awful.button.names.RIGHT, (t) => {
			if (client.focus !== undefined) {
		...
		awful.button<AwesomeTag>(undefined, awful.button.names.SCROLL_DOWN, (t) => {
			awful.tag.viewprev(t.screen);
		}),
		awful.button<AwesomeTag>(undefined, awful.button.names.SCROLL_UP, (t) => {
