...
interface AwesomeTagSignalMap extends SignalMap<AwesomeTagSignal> {
	 ...
	 *
	 * @param t The client's tag.
	 * @param c The tagged client.
	 */
	tagged: (this: void, t: AwesomeTag, c: AwesomeClient) => void;
	 ...
	 */
	untagged: (this: void, t: AwesomeTag, c: AwesomeClient) => void;

	/**
	 * Emitted when all clients are removed from the tag.
	 */
	cleared: (this: void, t: AwesomeTag) => void;
	 ...
	 */
	"property::urgent": (this: void, t: AwesomeTag, urgent: boolean) => void;
	 ...
	 */
	"property::urgent_count": (this: void, t: AwesomeTag, count: number) => void;
	 ...
	 */
	"request::screen": (this: void, t: AwesomeTag, context: string) => void;
