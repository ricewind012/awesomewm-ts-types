...
interface AwesomeClientSignalMap extends SignalMap<AwesomeClientSignal> {
	 ...
	 */
	focus: (this: void, c: AwesomeClient) => void;
	...
	// TODO: are {button,mouse}:: shared between yep ?
	/**
	 ...
	 */
	"mouse::leave": (this: void, c: AwesomeClient) => void;
	 ...
	 * @param urgent Is the client urgent?
	 */
	"request::urgent": (this: void, c: AwesomeClient, urgent: boolean) => void;
	 ...
	 */
	tagged: (this: void, c: AwesomeClient, t: AwesomeTag) => void;

	/**
	 * Emitted when a client gets unfocused.
	 */
	unfocus: (this: void, c: AwesomeClient) => void;

	/**
	 * Emitted when a client gets untagged.
	 */
	untagged: (this: void, c: AwesomeClient, t: AwesomeTag) => void;
	 ...
	 */
	"property::floating_geometry": (this: void, c: AwesomeClient) => void;
