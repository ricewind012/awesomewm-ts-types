...
interface WiboxContainerBorderProps {
	 ...
	 */
	border_image?: awesome_image | string;
	 ...
	 */
	border_images?: ImageSides<string | awesome_image>;
	 ...
	 */
	border_widgets?: ImageSides<BaseWidget>;

	/**
	 * Merge the corners widgets into the side widgets.
	 */
	border_merging?: AwesomeClientStrut;
...
interface WiboxContainerBorderConstructor {
	(props: BaseWidgetProps & WiboxContainerBorderProps): WiboxContainerBorder;
}
